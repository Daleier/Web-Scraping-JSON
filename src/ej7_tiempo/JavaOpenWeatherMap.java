 ...
 */
public class JavaOpenWeatherMap {
    static final String URL_OpenWeatherMap_weather_A_Coruña_ES = 
            "https://openweathermap.org/data/2.5/weather?id=3119841&units=metric&appid=b6907d289e10d714a6e88b30761fae22";
    public static void main(String[] args) {
        
        String result = "";
        
        try {
            URL url_weather = new URL(URL_OpenWeatherMap_weather_A_Coruña_ES);
            ...
            Logger.getLogger(JavaOpenWeatherMap.class.getName()).log(Level.SEVERE, null, ex);
    ...
    static private String ParseResult(String json) throws JSONException{
        ...
        String result_wind = "wind\tspeed: " + result_speed;
